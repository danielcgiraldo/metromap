...
<table><tbody>
    ...
    <tr>
        ...
        <td>
            ...
            <ul>
                <li>1.2 créditos por consulta a <code>/incident</code>
                </li>
                <li>0.8 créditos por consulta a <code>/incident/:line</code>
                </li>
                <li>0.6 créditos por consulta a <code>/incident/:line/:station</code>
                </li>
                </ul>
            </li>
