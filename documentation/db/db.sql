...
CREATE TABLE ALIAS(
    ...
    line CHAR(1) NOT NULL COMMENT 'FK of STATION(line)',
...
CREATE TABLE NOTIFICATION(
    tweet_id varchar(40) NOT NULL COMMENT 'id of the tweet to fetch content',
    incident varchar(20) NOT NULL COMMENT 'FK of INCIDENT(id)',
...
CREATE TABLE USER(
    ...
    secret_key VARCHAR(100) NOT NULL UNIQUE COMMENT 'not public key of the user, is a unique alternative identifiers',
    public_key VARCHAR(100) NOT NULL UNIQUE COMMENT 'public key of the user, is a unique alternative identifiers',
